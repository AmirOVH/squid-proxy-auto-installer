...
def squid(squid_username='amir', squid_password='amir123'):
    ...
    if not os_name.startswith("Ubuntu 16"):
        ...
        quit()
    run("/usr/bin/wget https://raw.githubusercontent.com/AmirOVH/squid-proxy-auto-installer/master/squid3-install.sh -O squid3-install.sh")
